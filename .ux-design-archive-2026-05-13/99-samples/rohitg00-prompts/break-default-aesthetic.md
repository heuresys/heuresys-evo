...
- **Inverse audit:** paste this _after_ generation as a "now audit what you just produced against this rubric and report FAILs" prompt — useful when you didn't seed the project up front.
