...
- Auth: NextAuth v4 Credentials, **8 canonical users** (`Heuresys2026!`) ristretti a `tests/.test-env` matrix (1 SUPERUSER + 7 RTL Bank roles). 5 utenti soft-deactivated (2 legacy + `admin`/`smartfood-admin`/`econova-admin` out-of-scope post-S22)
