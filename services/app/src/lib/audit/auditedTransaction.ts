/**
 * Phase 16 · L54 · S23 — P4 audit logging generalized helper.
 *
 * Generalizes the dashboard-audit pattern (`auditedDashboardMutation`) to
 * arbitrary categories/resources, exposing two flavors:
 *
 ...
 * Use 'CONFIG' for dashboard/brand/system-settings mutations.
 */
...
export async function auditEvent(
  ...
  try {
    ...
    // P4 prefers no-write to silent-bypass: log to stderr.
    // Caller already completed its primary effect — never throw upstream.
