...
1. **🆕 Doc consolidation Opt C** (L, ~14h sessione dedicated) — _NEW S10_
...
- **next-auth v5 timing**: aspettare release stable (probabilmente Q3-Q4 2026)? Oppure pinnare beta in branch staging come early adopter? _(carry-forward S8)_
