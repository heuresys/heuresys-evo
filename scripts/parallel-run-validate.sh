...
cat > "$DATA_FILE" <<JSON
{
  ...
  "manual_checklist": [
    "Login as canonical EMPLOYEE (francesca.gallo@rtl-bank.org/Heuresys2026!) on both stacks → both should reach /portal or /dashboard",
...
<ul class="checklist">
  <li>[ ] Login as canonical TENANT_OWNER <code>federica.marchetti@rtl-bank.org/Heuresys2026!</code> on both stacks — both should reach the dashboard</li>
