...
-- BEGIN handled by pipeline-v3 wrapper
-- =============================================================================
...
-- =============================================================================
-- ═══════════════════════════════════════════════════════════════════════════
-- INSERTED by pipeline-v3: DROP CASCADE 65 dependent views BEFORE stage 4 DROP COLUMN
...
-- =============================================================================
-- ═══════════════════════════════════════════════════════════════════════════
-- INSERTED by pipeline-v3: RECREATE 65 views AFTER VIEW employees + INSTEAD OF triggers
-- Forward topological order — deps first, dependents last
-- All defs already reference 'employees' (which is now the VIEW joining core+satellites)
-- ═══════════════════════════════════════════════════════════════════════════
-- analytics.v_candidate_summary
...
-- analytics.v_compliance_dashboard
...
-- analytics.v_employee_experience_score
...
-- analytics.v_employee_lifecycle
...
-- analytics.v_recruiting_pipeline
...
-- analytics.v_total_rewards_statement
...
-- learning.v_employee_learning_summary
...
-- public.mv_employee_performance_context
...
-- public.v_certification_compliance
...
-- public.v_employee_capability_snapshot
...
-- public.v_employee_career_overview
...
-- public.v_employee_learning_profile
...
-- public.v_employee_skill_summary
...
-- public.v_employee_skills_summary
...
-- public.v_feedback_given_summary
...
-- public.v_learning_path_progress
...
-- public.v_learning_skills_development
...
-- public.v_org_structure_summary
...
-- public.v_performance_skill_summary
...
-- public.v_tenant_employee_profile
...
-- public.vw_organizational_skill_intelligence
...
-- analytics.v_workforce_planning_dashboard
...
-- analytics.v_performance_snapshot
...
-- ═══════════════════════════════════════════════════════════════════════════
-- INSERTED by pipeline-v3: REFRESH mat views + final view-count assert
-- ═══════════════════════════════════════════════════════════════════════════
...
-- Verify all 65 phase16o views recreated successfully
DO $$
...
BEGIN
  ...
  IF v_count != 65 THEN
    RAISE EXCEPTION 'phase16o pipeline-v3 final: only % of 65 dependent views recreated', v_count;
  END IF;
  RAISE NOTICE 'phase16o pipeline-v3: 65/65 dependent views recreated successfully';
END;
$$;
...
-- COMMIT handled by pipeline-v3 wrapper
-- =============================================================================
-- POST-COMMIT NOTES
-- =============================================================================
--
