...
>
> **Last update**: 2026-05-06 (**L30 Phase 13.B done** · `dashboard_presets`+`dashboard_elements` migration + seed (9 preset, 30 element) · RLS attiva · sblocco Phase 13.C engine renderer)
...
| 13 — Dashboard data-driven        | 🟡 **13.0 done · 13.A done · 13.B done · 13.C next** | 6 sotto-phase 13.0→13.E · 41-51 FTE-day. **13.0 chiusa** (8/8 pack mining + Pack 2.3+2.6 reopen). **13.A chiusa** (8 atomic dashboard component TIER 17 · 21 test · L29). **13.B chiusa** (`dashboard_presets`+`dashboard_elements` migration 0002 · 9 preset + 30 element seeded · RLS attiva · L30). Next: **13.C** engine renderer + route `(dashboard)/[code]`. |
