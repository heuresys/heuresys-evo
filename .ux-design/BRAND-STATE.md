...
| 13 — Dashboard data-driven        | 🟡 **In progress · 13.0 starting** | 6 sotto-phase 13.0→13.E · 41-51 FTE-day · plan `C:\Users\enzospenuso\.claude\plans\credo-che-se-tu-jazzy-key.md`. 13.0 = forensic mining 8 pack legacy → `legacy-mining-log.md` append-only. Promotion checklist registry incorporato (`08-promotion/promotion-candidates.md`). |
